...
def inkomsten_totaal(ma, di, woe, don, vrij, zat, zon):
        ...
        uitvoer = f"Het bedrag van alle inkomsten van deze week is {inkomsten} eruo, waarover euro btw betaal dient te worden."
        return uitvoer
...
def gemiddelde(ma, di, woe, don, vrij, zat, zon):
        ...
        return f"De gemiddelde inkomstne van deze week zijn {gemiddelde} euro."

def meervouding(ma, di, woe, don, vrij, zat, zon):
...
print(meervouding(10,5,3,2,1,2,9))
print(combinatie("12,2"))